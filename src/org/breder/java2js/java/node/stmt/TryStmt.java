...
public final class TryStmt extends Statement {
  ...
  public TryStmt(int line, int column, BlockStmt tryBlock,
    List<CatchClause> catchs, BlockStmt finallyBlock) {
    super(line, column);
  ...
  public void writeJs(PrinterOutputStream output) throws IOException {
    this.tryBlock.writeJs(output);
    if (this.finallyBlock != null) {
      this.finallyBlock.writeJs(output);
    }
  }
