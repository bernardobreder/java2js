 ...
 * @author J�lio Vilmar Gesser (jgesser@gmail.com) - bug fixes and added AST
 *         generation
 */
public final class JavaParser implements JavaParserConstants {
  ...
  final public CompilationUnit CompilationUnit() throws ParseException {
    ...
    {
      if (true) {
        return new CompilationUnit(line == -1 ? 0 : line, column, pakage,
    ...
    label_4: while (true) {
      ...
      switch (jj_nt.kind) {
        case PUBLIC:
          ...
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.PUBLIC, token);
          break;
        case STATIC:
          jj_consume_token(STATIC);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.STATIC, token);
          break;
        case PROTECTED:
          jj_consume_token(PROTECTED);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.PROTECTED, token);
          break;
        case PRIVATE:
          jj_consume_token(PRIVATE);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.PRIVATE, token);
          break;
        case FINAL:
          jj_consume_token(FINAL);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.FINAL, token);
          break;
        case ABSTRACT:
          jj_consume_token(ABSTRACT);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.ABSTRACT, token);
          break;
        case SYNCHRONIZED:
          jj_consume_token(SYNCHRONIZED);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.SYNCHRONIZED, token);
          break;
        case NATIVE:
          jj_consume_token(NATIVE);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.NATIVE, token);
          break;
        case TRANSIENT:
          jj_consume_token(TRANSIENT);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.TRANSIENT, token);
          break;
        case VOLATILE:
          jj_consume_token(VOLATILE);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.VOLATILE, token);
          break;
        case STRICTFP:
          jj_consume_token(STRICTFP);
          modifiers =
            ModifierSet.addModifier(modifiers, ModifierSet.STRICTFP, token);
          break;
        case AT:
          ann = Annotation();
          annotations = add(annotations, ann);
  ...
  final public TypeDeclaration TypeDeclaration() throws ParseException {
    ...
    switch (jj_nt.kind) {
      case SEMICOLON:
        jj_consume_token(SEMICOLON);
        ret =
          new EmptyTypeDeclaration(token.beginLine, token.beginColumn,
            popJavadoc());
        break;
      case ABSTRACT:
      case CLASS:
  ...
  final public ClassOrInterfaceDeclaration ClassOrInterfaceDeclaration(
    ...
    {
      if (true) {
        return new ClassOrInterfaceDeclaration(line, column, popJavadoc(),
          modifier.modifiers, modifier.annotations, isInterface, name, typePar,
          extList, impList, members);
      }
    }
    throw new Error("Missing return statement in function");
  }
  ...
  final public EnumDeclaration EnumDeclaration(Modifier modifier)
    ...
    {
      if (true) {
        return new EnumDeclaration(line, column, popJavadoc(),
          modifier.modifiers, modifier.annotations, name, impList, entries,
          members);
      }
    }
    throw new Error("Missing return statement in function");
  ...
  final public EnumConstantDeclaration EnumConstantDeclaration()
    ...
    {
      if (true) {
        return new EnumConstantDeclaration(line, column, popJavadoc(),
    ...
    if (jj_2_6(2)) {
      ...
      switch (jj_nt.kind) {
        ...
        case SEMICOLON:
          jj_consume_token(SEMICOLON);
          ret =
            new EmptyMemberDeclaration(token.beginLine, token.beginColumn,
              popJavadoc());
          break;
        default:
          jj_la1[29] = jj_gen;
  ...
  final public FieldDeclaration FieldDeclaration(Modifier modifier)
    ...
    {
      if (true) {
        return new FieldDeclaration(type.getBeginLine(), type.getBeginColumn(),
          popJavadoc(), modifier.modifiers, modifier.annotations, type,
          variables);
      }
    }
    throw new Error("Missing return statement in function");
  ...
  final public VariableDeclarator VariableDeclarator() throws ParseException {
    ...
    {
      if (true) {
        return new VariableDeclarator(id.getBeginLine(), id.getBeginColumn(),
          id, init);
      }
    }
    throw new Error("Missing return statement in function");
  ...
  final public MethodDeclaration MethodDeclaration(Modifier modifier)
    ...
    {
      if (true) {
        return new MethodDeclaration(line, column, popJavadoc(),
          modifier.modifiers, modifier.annotations, typeParameters, type, name,
  ...
  final public Parameter FormalParameter() throws ParseException {
    ...
    {
      if (true) {
        return new Parameter(type.getBeginLine(), type.getBeginColumn(),
          modifier.modifiers, modifier.annotations, type, isVarArg, id);
      }
    }
    throw new Error("Missing return statement in function");
  }
  ...
  final public ConstructorDeclaration ConstructorDeclaration(Modifier modifier)
    ...
    {
      if (true) {
        return new ConstructorDeclaration(line, column, popJavadoc(),
          modifier.modifiers, modifier.annotations, typeParameters, name,
          parameters, throws_, new BlockStmt(bbLine, bbColumn, beLine,
            beColumn, stmts));
      }
    }
    throw new Error("Missing return statement in function");
  ...
  final public ExplicitConstructorInvocationStmt ExplicitConstructorInvocation()
    ...
    {
      if (true) {
        return new ExplicitConstructorInvocationStmt(line, column, typeArgs,
          isThis, expr, args);
      }
    }
    throw new Error("Missing return statement in function");
  ...
  final public ReferenceType ReferenceType() throws ParseException {
    ...
    {
      if (true) {
        return new ReferenceType(type.getBeginLine(), type.getBeginColumn(),
          type, arrayCount);
      }
    }
    throw new Error("Missing return statement in function");
  ...
  final public PrimitiveType PrimitiveType() throws ParseException {
    ...
    switch (jj_nt.kind) {
      case BOOLEAN:
        ...
        ret =
          new PrimitiveType(token.beginLine, token.beginColumn,
  ...
  final public NameExpr Name() throws ParseException {
    ...
    label_23: while (true) {
      ...
      jj_consume_token(IDENTIFIER);
      ret =
        new QualifiedNameExpr(token.beginLine, token.beginColumn, ret,
          token.image);
    }
    {
      if (true) {
  ...
  final public Expression Expression() throws ParseException {
    ...
    if (jj_2_18(2)) {
      ...
      value = Expression();
      ret =
        new AssignExpr(ret.getBeginLine(), ret.getBeginColumn(), ret, value, op);
    }
    else {
      ;
    }
  ...
  final public Expression ConditionalExpression() throws ParseException {
    ...
    switch (jj_nt.kind) {
      case HOOK:
        ...
        ret =
          new ConditionalExpr(ret.getBeginLine(), ret.getBeginColumn(), ret,
            left, right);
        break;
      default:
        jj_la1[60] = jj_gen;
  ...
  final public Expression ConditionalOrExpression() throws ParseException {
    ...
    label_25: while (true) {
      ...
      ret =
        new BinaryExpr(ret.getBeginLine(), ret.getBeginColumn(), ret, right,
  ...
  final public Expression EqualityExpression() throws ParseException {
    ...
    label_30: while (true) {
      ...
      ret =
        new BinaryExpr(ret.getBeginLine(), ret.getBeginColumn(), ret, right, op);
    }
    {
      if (true) {
        return ret;
  ...
  final public Expression InstanceOfExpression() throws ParseException {
    ...
    switch (jj_nt.kind) {
      case INSTANCEOF:
        ...
        type = Type();
        ret =
          new InstanceOfExpr(ret.getBeginLine(), ret.getBeginColumn(), ret,
            type);
        break;
      default:
        jj_la1[68] = jj_gen;
      ...
      case MINUS:
        ...
        if (op == UnaryExpr.Operator.negative) {
          if (ret instanceof IntegerLiteralExpr
            ...
            ret =
              new IntegerLiteralMinValueExpr(ret.getBeginLine(), ret
                .getBeginColumn());
          }
          else if (ret instanceof LongLiteralExpr
            && ((LongLiteralExpr) ret).isMinValue()) {
            ret =
              new LongLiteralMinValueExpr(ret.getBeginLine(), ret
                .getBeginColumn());
          }
          else {
  ...
  final public Expression PrimaryPrefix() throws ParseException {
    ...
    switch (jj_nt.kind) {
      ...
      case SUPER:
        ...
        ret =
          hasArgs ? new MethodCallExpr(line, column, ret, typeArgs, name, args)
        ...
        if (jj_2_27(2147483647)) {
          ...
          switch (jj_nt.kind) {
            case IDENTIFIER:
              ...
              ret =
                hasArgs ? new MethodCallExpr(line, column, null, null, name,
                  args) : new NameExpr(line, column, name);
              break;
            default:
              jj_la1[87] = jj_gen;
              jj_consume_token(-1);
        ...
        switch (jj_nt.kind) {
          ...
          default:
            ...
            if (jj_2_29(2147483647)) {
              ...
              ret =
                hasArgs ? new MethodCallExpr(line, column, scope, typeArgs,
                  name, args) : new FieldAccessExpr(line, column, scope,
                  typeArgs, name);
            }
            else {
              jj_consume_token(-1);
  ...
  final public Expression Literal() throws ParseException {
    ...
    switch (jj_nt.kind) {
      case INTEGER_LITERAL:
        ...
        ret =
          new IntegerLiteralExpr(token.beginLine, token.beginColumn,
            token.image);
        break;
      case LONG_LITERAL:
        jj_consume_token(LONG_LITERAL);
        ret =
          new LongLiteralExpr(token.beginLine, token.beginColumn, token.image);
        break;
      case FLOATING_POINT_LITERAL:
        jj_consume_token(FLOATING_POINT_LITERAL);
        ret =
          new DoubleLiteralExpr(token.beginLine, token.beginColumn, token.image);
        break;
      case CHARACTER_LITERAL:
        jj_consume_token(CHARACTER_LITERAL);
        ret =
          new CharLiteralExpr(token.beginLine, token.beginColumn, token.image
            .substring(1, token.image.length() - 1));
        break;
      case STRING_LITERAL:
        jj_consume_token(STRING_LITERAL);
        ret =
          new StringLiteralExpr(token.beginLine, token.beginColumn, token.image
            .substring(1, token.image.length() - 1));
        break;
      case FALSE:
      case TRUE:
  ...
  final public Expression BooleanLiteral() throws ParseException {
    ...
    switch (jj_nt.kind) {
      case TRUE:
        ...
        ret =
          new BooleanLiteralExpr(token.beginLine, token.beginColumn,
            Boolean.TRUE);
        break;
      case FALSE:
    ...
    switch (jj_nt.kind) {
      ...
      case SHORT:
        ...
        if (arr[0] instanceof Integer) {
          ret =
            new ArrayCreationExpr(line, column, type, null, ((Integer) arr[0])
              .intValue(), (ArrayInitializerExpr) arr[1]);
        }
        else {
          ret =
            new ArrayCreationExpr(line, column, type, null, (List) arr[0],
      ...
      case LT:
        ...
        switch (jj_nt.kind) {
          case LBRACKET:
            ...
            if (arr[0] instanceof Integer) {
              ret =
                new ArrayCreationExpr(line, column, type, typeArgs,
                  ((Integer) arr[0]).intValue(), (ArrayInitializerExpr) arr[1]);
            }
            else {
              ret =
                new ArrayCreationExpr(line, column, type, typeArgs,
                  (List) arr[0], ((Integer) arr[1]).intValue());
            }
            break;
          case LPAREN:
            args = Arguments();
            ...
            ret =
              new ObjectCreationExpr(line, column, scope,
  ...
  /*
   * Classes inside block stametents can only be abstract or final. The semantic
   * must check it.
   */
  final public Statement BlockStatement() throws ParseException {
    ...
    if (jj_2_35(2147483647)) {
      ...
      ret =
        new TypeDeclarationStmt(typeDecl.getBeginLine(), typeDecl
          .getBeginColumn(), typeDecl);
    }
    else if (jj_2_36(2147483647)) {
      expr = VariableDeclarationExpression();
      ret =
        new ExpressionStmt(expr.getBeginLine(), expr.getBeginColumn(), expr);
      jj_consume_token(SEMICOLON);
    }
    else {
      switch (jj_nt.kind) {
  ...
  final public VariableDeclarationExpr VariableDeclarationExpression()
    ...
    {
      if (true) {
        return new VariableDeclarationExpr(type.getBeginLine(), type
          .getBeginColumn(), modifier.modifiers, modifier.annotations, type,
          vars);
      }
    }
    throw new Error("Missing return statement in function");
  ...
  final public ExpressionStmt StatementExpression() throws ParseException {
          ...
          case RUNSIGNEDSHIFTASSIGN:
            switch (jj_nt.kind) {
              case INCR:
                jj_consume_token(INCR);
                expr =
                  new UnaryExpr(expr.getBeginLine(), expr.getBeginColumn(),
              ...
              case RUNSIGNEDSHIFTASSIGN:
                ...
                value = Expression();
                expr =
                  new AssignExpr(expr.getBeginLine(), expr.getBeginColumn(),
                    expr, value, op);
                break;
              default:
                jj_la1[106] = jj_gen;
    ...
    {
      if (true) {
        return new ExpressionStmt(expr.getBeginLine(), expr.getBeginColumn(),
          expr);
      }
    }
    throw new Error("Missing return statement in function");
    ...
    switch (jj_nt.kind) {
      case CATCH:
        label_44: while (true) {
          ...
          catchBlock = Block();
          catchs =
            add(catchs, new CatchClause(cLine, cColumn, except, catchBlock));
          switch (jj_nt.kind) {
            case CATCH:
              ;
              break;
  ...
  final public AnnotationDeclaration AnnotationTypeDeclaration(Modifier modifier)
    ...
    {
      if (true) {
        return new AnnotationDeclaration(line, column, popJavadoc(),
  ...
  final public AnnotationMemberDeclaration AnnotationTypeMemberDeclaration(
    ...
    {
      if (true) {
        return new AnnotationMemberDeclaration(type.getBeginLine(), type
          .getBeginColumn(), popJavadoc(), modifier.modifiers,
          modifier.annotations, type, name, defaultVal);
      }
    }
    throw new Error("Missing return statement in function");
  }
  ...
  private static void jj_la1_init_0() {
    jj_la1_0 =
      new int[] { 0x0, 0x48101000, 0x1, 0x0, 0x0, 0x0, 0x40001000, 0x8100000,
          0x48101000, 0x100000, 0x0, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x4a195000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x0, 0x4a195000,
          0x8100000, 0x2094000, 0x4a195000, 0x0, 0x0, 0x0, 0x22094000,
          0x22094000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x42095000, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x22094000, 0x6359f000, 0x0, 0x2094000, 0x2094000, 0x0,
          0x2094000, 0x10000000, 0x10000000, 0x2094000, 0x2094000, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x22094000, 0x0, 0x0, 0x22094000, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20000000,
          0x20000000, 0x22094000, 0x0, 0x0, 0x0, 0x2094000, 0x0, 0x0,
          0x2349e000, 0x0, 0x2349e000, 0x0, 0x0, 0x0, 0x22094000, 0x820000,
          0x820000, 0x4000000, 0x62095000, 0x22094000, 0x22094000, 0x62095000,
          0x22094000, 0x0, 0x0, 0x0, 0x22094000, 0x40000, 0x80000000,
          0x80040000, 0x0, 0x0, 0x0, 0x22094000, 0x22094000, 0x0, 0x4a195000,
          0xa194000, 0x4a195000, 0x800000, };
  }

  private static void jj_la1_init_1() {
    jj_la1_1 =
      new int[] { 0x20, 0x8899c500, 0x0, 0x0, 0x80000, 0x0, 0x8899c400, 0x100,
          0x8899c500, 0x100, 0x0, 0x0, 0x10, 0x0, 0x0, 0x10, 0x0, 0x0,
          0xc89dc781, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc89dc781, 0x100,
          0x40040281, 0xc89dc781, 0x0, 0x0, 0x0, 0x51241a81, 0x51241a81, 0x0,
          0x0, 0x0, 0x4000000, 0x0, 0x0, 0x889dc681, 0x0, 0x0, 0x4000000, 0x0,
          0x0, 0x51241a81, 0xfbffdf8b, 0x80000, 0x40281, 0x40281, 0x0, 0x40281,
          0x200000, 0x200000, 0x40281, 0x40040281, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x51241a81, 0x0, 0x0, 0x51241a81, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x11201800, 0x0, 0x0, 0x0, 0x0, 0x1000800, 0x0, 0x10001000,
          0x10000000, 0x51241a81, 0x0, 0x0, 0x0, 0x40281, 0x0, 0x0, 0x73e61a8b,
          0x0, 0x73e61a8b, 0x0, 0x0, 0x0, 0x51241a81, 0x0, 0x0, 0x0,
          0xd9bdde81, 0x51241a81, 0x51241a81, 0xd9bdde81, 0x51241a81, 0x0, 0x0,
          0x0, 0x51241a81, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x51241a81,
          0x51241a81, 0x0, 0x889dc781, 0x40381, 0x889dc781, 0x0, };
  }

  private static void jj_la1_init_2() {
    jj_la1_2 =
      new int[] { 0x0, 0x2400000, 0x0, 0x2000000, 0x0, 0x1000000, 0x2000000,
          0x2000000, 0x2400000, 0x0, 0x8000000, 0x0, 0x0, 0x800000, 0x800000,
          0x0, 0x2002000, 0x800000, 0xa442000, 0x400000, 0x2000000, 0x10000,
          0x40000, 0x800000, 0x0, 0x0, 0xa442000, 0x2000000, 0x8002000,
          0xa402000, 0x800000, 0x4000000, 0x100000, 0x30053846, 0x30053846,
          0x800000, 0x8000000, 0x100000, 0x0, 0x440000, 0x800000, 0x2002000,
          0x0, 0x8000000, 0x0, 0x8000000, 0x8000000, 0x8013846, 0x2453847, 0x0,
          0x0, 0x2000, 0x800000, 0x40002000, 0x0, 0x0, 0x0, 0x2000, 0x800000,
          0x4000000, 0x40000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x8000000, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x30013846,
          0x30000000, 0x30000000, 0x13846, 0x10000, 0x0, 0x8000000, 0x10000,
          0x10000, 0x11846, 0x2000, 0x1000000, 0x8000000, 0x10000, 0x0,
          0x1100000, 0x1846, 0x0, 0x30013846, 0x800000, 0x8000000, 0x110000,
          0x8002000, 0x100000, 0x100000, 0x453847, 0x80000000, 0x453847,
          0x800000, 0x4000000, 0x4000000, 0x13846, 0x0, 0x0, 0x0, 0x32013846,
          0x30013846, 0x30013846, 0x32413846, 0x30013846, 0x800000, 0x2000,
          0x2000, 0x30013846, 0x0, 0x0, 0x0, 0x2000000, 0x2000, 0x800000,
          0x32053846, 0x32053846, 0x800000, 0x2402000, 0x2002000, 0x2402000,
          0x0, };
  }

  private static void jj_la1_init_3() {
    jj_la1_3 =
      new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x1000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3c0, 0x3c0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffe0000, 0x0,
          0x10, 0x20, 0x2000, 0x4000, 0x1000, 0x9, 0x9, 0x0, 0x80000006,
          0x80000006, 0x10000, 0x300, 0x300, 0x8c00, 0x8c00, 0x300, 0x3c0, 0x0,
          0x0, 0x0, 0x0, 0xc0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x3c0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc0, 0x0, 0xc0,
          0x0, 0xffe00c0, 0xffe00c0, 0xc0, 0x0, 0x0, 0x0, 0x3c0, 0x3c0, 0x3c0,
          0x3c0, 0x3c0, 0x0, 0x0, 0x0, 0x3c0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x3c0, 0x3c0, 0x0, 0x0, 0x0, 0x0, 0x0, };
  }

  private static void jj_la1_init_4() {
    jj_la1_4 =
      new int[] { 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
          0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
